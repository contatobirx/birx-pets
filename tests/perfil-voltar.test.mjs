...
test("o app abre o perfil na mesma tela",()=>{assert.match(navigation,/window\.location\.href = url/);assert.doesNotMatch(navigation,/window\.open\(url/);assert.match(html,/pet\.js\?v=3\.3/)});
