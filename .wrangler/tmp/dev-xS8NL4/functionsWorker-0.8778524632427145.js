...
// .wrangler/tmp/pages-Nfcn0y/functionsWorker-0.8778524632427145.mjs
...
__name2(textoOuNulo, "textoOuNulo");
function somenteNumeros(valor) {
  return String(valor || "").replace(/\D/g, "");
}
__name(somenteNumeros, "somenteNumeros");
__name2(somenteNumeros, "somenteNumeros");
function normalizarEmail(valor) {
  return String(valor || "").trim().toLowerCase();
}
__name(normalizarEmail, "normalizarEmail");
__name2(normalizarEmail, "normalizarEmail");
...
__name2(validarFotoUrl, "validarFotoUrl");
...
__name2(respostaJson, "respostaJson");
function normalizarEmail2(email) {
  return String(email || "").trim().toLowerCase();
}
__name(normalizarEmail2, "normalizarEmail2");
__name2(normalizarEmail2, "normalizarEmail");
function emailValido2(email) {
  return /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email);
}
__name(emailValido2, "emailValido2");
__name2(emailValido2, "emailValido");
...
__name2(gerarCodigo, "gerarCodigo");
...
__name(respostaJson2, "respostaJson2");
__name2(respostaJson2, "respostaJson");
function normalizarEmail3(email) {
  return String(email || "").trim().toLowerCase();
}
__name(normalizarEmail3, "normalizarEmail3");
__name2(normalizarEmail3, "normalizarEmail");
function emailValido3(email) {
  return /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email);
}
__name(emailValido3, "emailValido3");
__name2(emailValido3, "emailValido");
function codigoValido(codigo) {
  return /^\d{6}$/.test(String(codigo || "").trim());
}
__name(codigoValido, "codigoValido");
__name2(codigoValido, "codigoValido");
async function gerarHash2(texto) {
  const dados = new TextEncoder().encode(texto);
  const hash = await crypto.subtle.digest("SHA-256", dados);
  return Array.from(new Uint8Array(hash)).map((byte) => byte.toString(16).padStart(2, "0")).join("");
}
__name(gerarHash2, "gerarHash2");
__name2(gerarHash2, "gerarHash");
...
__name2(gerarTokenSeguro, "gerarTokenSeguro");
...
__name(respostaJson3, "respostaJson3");
__name2(respostaJson3, "respostaJson");
...
__name2(obterCookie, "obterCookie");
...
__name2(gerarHashSha256, "gerarHashSha256");
...
__name2(registrarLeitura, "registrarLeitura");
...
__name(obterCookie2, "obterCookie2");
__name2(obterCookie2, "obterCookie");
...
__name2(limparCodigo, "limparCodigo");
...
// .wrangler/tmp/bundle-GRI80p/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-GRI80p/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8778524632427145.js.map
