...
export async function onRequestGet({request,env}){
  try{
    ...
    return json({sucesso:true,pedido:{...order,itens:itemsResult.results||[],eventos:eventsResult.results||[],comprovanteEnviado:Boolean(order.comprovanteEnviadoEm),pixCopiaECola:order.statusPagamento==="aguardando"?order.pixCopiaECola:null}});
